...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ExButton.setGeometry(QtCore.QRect(610, 460, 85, 51))
        self.ExButton.setFont(font)
        self.ExButton.setObjectName("ExButton")
        self.PDFButton = QtWidgets.QPushButton(self.centralwidget)
        self.PDFButton.setGeometry(QtCore.QRect(710, 460, 81, 51))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ExButton.setText(_translate("MainWindow", "В excel"))
        self.SearchButton.setText(_translate("MainWindow", "Поиск"))
        self.PDFButton.setText(_translate("MainWindow", "В PDF"))
